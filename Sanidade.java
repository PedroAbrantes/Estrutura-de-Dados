...
class Sanidade {
    ...
    public static boolean isSane(String s1, String s2, int dif) throws Exception
    {
        int aux = dif - 1;
    ...
    //vai montar a lista
    public static void montaLista(LDE minhaLista1, LinkedList lista2) throws Exception
    {
